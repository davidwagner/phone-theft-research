...
if __name__ == '__main__':
    ...
    if MUL_AFTER_WINS: 
        dp.T.to_csv('data/features_win_size_1_({})1.csv'.format(NUM_AFTER_WINS), header=True)
    else:
        dp.T.to_csv('data/features_win_size_1_2_new_pos.csv'.format(WIN_SIZE_AFTER), header=True)
