...
Similarly, Mare et~al.\ developed a recurring authentication system that utilizes the user's hand movement to verify and grant computer terminal access~\cite{mare:zebra}. 
Their continuous authentication scheme can correctly verify 90\% of users and identify all adversaries.
One downside is that they require users to wear a bracelet while interacting with a computer.
