...
if __name__ == '__main__':
	for DATA_DAY in DATA_DATES:
		...
		summaryFile = open('bt-connected-summary-' + DATA_DAY + '_' + NOW_TIME +'.csv', 'w+')
		logFile = open('bt-connected-log-' + DATA_DAY + '_' + NOW_TIME +'.txt', 'w+')
		...
		for USER_ID in USERS:
			...
			try :
				...
				print(tb)
				logFile.write("******EXCEPTION (while computing " + USER_ID + " )*******\n")
				logFile.write(tb)
