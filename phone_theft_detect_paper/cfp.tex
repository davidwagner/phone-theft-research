...
We also tested our classifiers on a set of 120 positive data points collected using a Nexus 6P. A detection rate of 98.3\% indicates that our detector works with other smartphone models.
