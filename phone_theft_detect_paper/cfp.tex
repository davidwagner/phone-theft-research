...
We collected an additional set of 45 trials, 15 instances from each scenario using a Nexus 6P smartphone with Android version 6.0.1 to demonstrate our classifier can generaize to different smartphone models.
...
We also tested our classifiers on a set of 45 positive data points collected using a Nexus 6P. A highest detection rate of 97.8\% indicates that our detector works with other smartphone models.
