...
the score for feature $i$ is $|\alpha_i| \times \sigma_i$, where $\alpha_i$ is the coefficient for feature $i$ and $\sigma_i$ is the standard deviation of feature $i$ in the training set.
Then we get the adjusted coefficients as the feature importances of logistic regression as 2.73319487, 0.0129842047, 0.477534932, 0.0143829911, 1.18427357, 0.0470492037, 0.0580951517, 0.880738694, 0.666823228, \\0.937781183, 0.273227115, 2.69540663, from which we can tell the most important features are
