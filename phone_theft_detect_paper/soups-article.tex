...
We find that logistic regression has 34 false positive instances at a 41.7\% true positive rate (25 true positive instances),
while random forests has 33 false positive instances at a 46.7\% true positive rate (28 true positive instances).
...
\section{Discussion}
In this work, we demonstrate that with proper feature extraction we can use accelerometer data alone to detect some common forms of smartphone theft, such as pickpocket and grab-and-run, without sacrificing user experience. 
